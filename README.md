...
| `dashboard.py` | Generates `dashboard.html`, an interactive risk factor dashboard |
...
`python dashboard.py` writes a self contained `dashboard.html` that opens in any browser.
It replaces the original Power BI report and fixes three problems that report had.
